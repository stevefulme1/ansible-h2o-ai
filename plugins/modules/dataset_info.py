...
"""Ansible module to query H2O.ai dataset resources."""
...
---
module: dataset_info
short_description: List or retrieve H2O.ai datasets
description:
    - Retrieve information about H2O.ai dataset resources.
version_added: "1.0.0"
author:
...
- name: List all datasets
  stevefulme1.h2o_ai.dataset_info:
...
def main():
    ...
    module.exit_json(changed=False, datasets=items)
