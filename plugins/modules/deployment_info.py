...
"""Ansible module to query H2O.ai deployment resources."""
...
short_description: List or retrieve H2O.ai deployments
description:
    - Retrieve information about H2O.ai deployment resources.
version_added: "1.0.0"
author:
...
options:
    deployment_id:
        description:
            - The deployment id for the H2O.ai resource.
        type: str
...
- name: List all deployments
  stevefulme1.h2o_ai.deployment_info:
