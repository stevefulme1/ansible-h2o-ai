...
"""Ansible module to query H2O.ai project resources."""
...
---
module: project_info
short_description: List or retrieve H2O.ai projects
description:
    - Retrieve information about H2O.ai project resources.
version_added: "1.0.0"
author:
...
- name: List all projects
  stevefulme1.h2o_ai.project_info:
