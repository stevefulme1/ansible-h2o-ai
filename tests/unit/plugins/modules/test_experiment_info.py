"""Unit tests for stevefulme1.h2o_ai.experiment_info module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.h2o_ai.plugins.modules.experiment_info"
CLIENT_PATH = "ansible_collections.stevefulme1.h2o_ai.plugins.module_utils.api_client"


class TestInfo:
    """Test experiment_info info retrieval."""

    @patch(f"{CLIENT_PATH}.requests")
    def test_list_experiments(self, mock_requests, module_args):
        """Listing experiments returns items."""
